...
// f2.txt is an autogenerated file by the above command. //Fun fact -> You can delete all the data in f2.txt, and everytime you'll run the command, f1.txt content will appear there in capitilized form.